...
<div class="grid sm:grid-cols-2 gap-3 max-w-2xl">
    <a href="{{ route('patient.consultation.generalistes') }}" class="bg-white border border-slate-200 rounded-lg p-6 hover:border-slate-300 hover:shadow-sm transition">
        <div class="w-9 h-9 rounded-md border border-slate-200 flex items-center justify-center mb-4 text-slate-600">
            <svg width="17" height="17" fill="none" stroke="currentColor" stroke-width="1.75"><path d="M17.982 18.725A7.488 7.488 0 0012 15.75a7.488 7.488 0 00-5.982 2.975m11.963 0a9 9 0 10-11.963 0m11.963 0A8.966 8.966 0 0112 21a8.966 8.966 0 01-5.982-2.275M15 9.75a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
        </div>
    ...
    <a href="{{ route('patient.consultation.specialites') }}" class="bg-white border border-slate-200 rounded-lg p-6 hover:border-slate-300 hover:shadow-sm transition">
        <div class="w-9 h-9 rounded-md border border-slate-200 flex items-center justify-center mb-4 text-slate-600">
