...
@endphp
    ...
    <x-nav-item :route="route('medecin.patients')" :active="$active === 'patients'" :icon="$icon('<path d=\'M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0z\'/>')">
        Mes patients
    </x-nav-item>
    <div class="relative">
        ...
        <span x-show="nbDemandes > 0" x-cloak x-text="nbDemandes" class="absolute top-1.5 right-2 bg-coral-500 text-white text-[10px] font-bold w-4 h-4 rounded-full flex items-center justify-center"></span>
    </div>
    ...
    <x-nav-item :route="route('communaute.index')" :active="$active === 'communaute'" :icon="$icon('<path d=\'M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.764 9.764 0 01-2.555-.337A5.972 5.972 0 015.41 20.97a5.969 5.969 0 01-.474-.065 4.48 4.48 0 00.978-2.025c.09-.457-.133-.901-.467-1.226C3.93 16.178 3 14.189 3 12c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25z\'/>')">
    Communauté
</x-nav-item>
