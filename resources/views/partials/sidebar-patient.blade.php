...
<x-nav-item :route="route('patient.plaintes.index')" :active="$active === 'plaintes'" :icon="$icon('<path d=\'M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm7.5 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zM21 12a9 9 0 11-18 0 9 9 0 0118 0z\'/>')">
    Reclamation
</x-nav-item>
