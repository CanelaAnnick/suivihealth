<div class="grid grid-cols-4">
    ...
    <a href="{{ route('medecin.rendezvous') }}" class="flex flex-col items-center gap-1 py-2.5 {{ request()->routeIs('medecin.rendezvous') ? 'text-navy-900' : 'text-slate-400' }}">
        ...
        <span class="text-[9.5px] font-medium">Rendez-vous</span>
    </a>
